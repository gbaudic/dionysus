...
public enum PaymentMethod implements Serializable{
	 ...
	 * "Moneo" was a French card system which looks like a credit card, except that it is loaded with a given amount and can be refilled.
	 ...
	 * Note that the use of this system stopped in the summer of 2015.
	 */
